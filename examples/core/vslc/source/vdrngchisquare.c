...
/*
!  Content:
!    vdRngChiSquare  Example Program Text
!******************************************************************************/
...
#define METHOD  VSL_RNG_METHOD_CHISQUARE_CHI2GAMMA
#define N       1000
#define NN      10
...
int main()
{
    ...
    /***** Call RNG *****/
    errcode = vdRngChiSquare( METHOD, stream, N, r, v );
    CheckVslError( errcode );
    ...
    /***** Printing results *****/
    printf("Sample of vdRngChiSquare.\n");
    printf("------------------------\n\n");
    printf("Parameters:\n");
    printf("    v=%d\n",v);
