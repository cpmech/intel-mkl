...
/*
*   Content : Intel(R) MKL Sparse QR C example
*
********************************************************************************
*
* Consider the sparse rectangular matrix A: (see 'Sparse Storage Formats for
* Sparse BLAS Level 2 and Level 3 in the Intel(R) MKL Reference Manual')
*
*                 |   1       -1      0   -3     0   |
*                 |  -2        5      0    0     0   |
*   A    =        |   0        0      0    6     4   |,
...
*
*  The example solve system  Ax = b using next routines:
...
/* Calling reordering step of Sparse QR */
    CALL_AND_CHECK_STATUS ( mkl_sparse_qr_reorder( csrA, descr ),
                           "Error after MKL_SPARSE_D_QR_REORDER, csrA \n" );

/* Calling factorization step of Sparse QR */
    CALL_AND_CHECK_STATUS ( mkl_sparse_d_qr_factorize( csrA, NULL ),
                           "Error after MKL_SPARSE_D_QR_FACTORIZE, csrA \n" );

/* Calling solving step for Sparse QR */
    CALL_AND_CHECK_STATUS ( mkl_sparse_d_qr_solve ( SPARSE_OPERATION_NON_TRANSPOSE, csrA, NULL, SPARSE_LAYOUT_COLUMN_MAJOR, 1, x, ncols, b, nrows ),
                           "Error after MKL_SPARSE_D_QR_MULT, csrA \n" );
...
/* Checking correctness of Sparse QR result and free data */
    CALL_AND_CHECK_STATUS ( mkl_sparse_d_mv ( SPARSE_OPERATION_NON_TRANSPOSE, 1., csrA, descr, x, 0., r ),
