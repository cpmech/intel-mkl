...
/*      Call CBLAS_SGEMM_PACK_GET_SIZE and MKL_MALLOC functions to allocate buffer for A (C Interface) */
      identifier = CblasAMatrix;
      destsize = cblas_sgemm_pack_get_size(identifier, m, n, k);
...
/*      Call CBLAS_SGEMM_PACK subroutine to perform scaling and packing (C Interface) */
      cblas_sgemm_pack(layout, identifier, transA, m, n, k, alpha, a, lda, dest);
/*      Call CBLAS_SGEMM_COMPUTE subroutine (C Interface)                     */
      storage = CblasPacked;
