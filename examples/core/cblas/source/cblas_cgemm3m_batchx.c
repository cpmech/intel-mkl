...
/*      Call CGEMM3M_BATCH subroutine ( C Interface )                  */
      cblas_cgemm3m_batch(layout, &transA[0], &transB[0], &m[0], &n[0], &k[0],
              &alpha[0], (const void **) a_array, &lda[0],
              (const void **) b_array, &ldb[0], &beta[0], (void **) c_array,
              &ldc[0], grp_count, &grp_sizes[0]);
