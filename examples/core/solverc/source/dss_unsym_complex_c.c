...
/* ------------------------ */
  ...
  mkl_sparse_z_create_csr ( &csrA, SPARSE_INDEX_BASE_ONE, nRows, nCols, rowIndex, rowIndex+1, columns, values );
...
// Compute rhs respectively to uplo to have solution solValue
      mkl_sparse_z_mv( transA, alpha, csrA, descrA, solValues, beta, rhs);
