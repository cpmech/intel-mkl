...
/*
!  Content:
!     vsRemainder Example Program Text
!******************************************************************************/
...
int main()
{
  ...
  fB[3]=-9.3330001831054688e-01;
  fB[4]=-1.6669988632202148e-01;
  fB[5]=-5.1109981536865234e-01;
  fB[6]=1.3666996955871582e+00;
  fB[7]=-8.8900089263916016e-02;
  ...
  for(i=0;i<10;i++) {
    ...
    if(fBla1[i]!=fBla2[i]) {
      printf("Error! Difference between vsRemainder and vmsRemainder in VML_LA mode detected.\n");
      return 1;
    }
  ...
  printf("vsRemainder test/example program\n\n");
